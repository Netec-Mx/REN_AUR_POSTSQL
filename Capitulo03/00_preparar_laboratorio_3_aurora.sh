#!/usr/bin/env bash
# ==============================================================================
# Script: 00_preparar_laboratorio_3_aurora.sh
# Propósito: Preparar los prerrequisitos técnicos del Laboratorio 3
#            "Carga controlada y métricas operativas" en AWS CloudShell.
#
...
# - Esta versión trabaja en la raíz actual de CloudShell. No crea directorios
#   scripts, logs ni results.
# ==============================================================================
...
# Lab 3 trabaja en la raíz actual.
export LAB_WORKDIR="${LAB_WORKDIR:-$PWD}"
export WORKDIR="${WORKDIR:-$LAB_WORKDIR}"

# Parámetros de carga usados por el Laboratorio 3.
export LAB3_OPERACIONES="${LAB3_OPERACIONES:-80}"
export LAB3_CONCURRENCIA="${LAB3_CONCURRENCIA:-4}"
export LAB3_ESCENARIO="${LAB3_ESCENARIO:-carga_controlada_baja}"

ENV_FILE="${ENV_FILE:-./lab3_aurora_env.sh}"
...
log "Validando psycopg2 para el Laboratorio 3"

# En algunos CloudShell hay virtualenv activo y pip rechaza --user.
# Por eso primero intentamos importar; si falla, instalamos según el entorno.
...
ok "Dependencia Python validada"

log "Directorio de trabajo del Laboratorio 3"
pwd
...
# -----------------------------
# Parameter Group opcional para consistencia con Lab 1 / Lab 2
# -----------------------------
...
cat > "$ENV_FILE" <<EOF
# Variables generadas por 00_preparar_laboratorio_3_aurora.sh
...
export LAB3_OPERACIONES='$LAB3_OPERACIONES'
export LAB3_CONCURRENCIA='$LAB3_CONCURRENCIA'
export LAB3_ESCENARIO='$LAB3_ESCENARIO'
EOF
...
Antes de iniciar el Laboratorio 3, ejecuta:
  source ./lab3_aurora_env.sh
