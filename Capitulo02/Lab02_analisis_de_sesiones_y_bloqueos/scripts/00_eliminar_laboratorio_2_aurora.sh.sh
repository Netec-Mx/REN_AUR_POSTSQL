#!/usr/bin/env bash
# ==============================================================================
# Script: 00_eliminar_laboratorio_2_aurora.sh
# Propósito: Eliminar los recursos creados para el Laboratorio 2
#            "Análisis de sesiones y bloqueos" en Aurora PostgreSQL.
#
# Ejecutar en AWS CloudShell:
#   chmod +x 00_eliminar_laboratorio_2_aurora.sh
#   ./00_eliminar_laboratorio_2_aurora.sh
#
# Si existe el archivo de variables generado por el script de preparación:
#   ./lab2_aurora_env.sh
#
...
if [[ -z "$AURORA_SG_ID" || "$AURORA_SG_ID" == "None" ]]; then
  ...
  if aws ec2 describe-security-groups \
    ...
    aws ec2 delete-security-group \
      --region "$AWS_REGION" \
      --group-id "$AURORA_SG_ID" >/dev/null
...
# -----------------------------
# Eliminar archivo de variables local
# -----------------------------
log "Limpieza local"
...
ok "Eliminación del laboratorio completada"
